...
structure = {
    'deals': {
        'Калужская область': {
            # 'Калуга': ['2024-06-10.csv', 'file_n.csv'],
            'Калужская область': ['2024-06-10.csv', 'file_n.csv']
        },
        'Московская область': {
            'Москва': ['2024-06-10.csv', 'file_n.csv'],
            'Московская область': ['2024-06-11.csv', 'file_n.csv']
        }
    },
    'full_objects': {
        # 'Калужская область': {
        ...
        'Московская область': {
            'Москва': ['2024-06-10.csv', 'file_n.csv'],
            'Московская область': ['2024-06-10.csv', 'file_n.csv']
        }
    },
    'prices': {
        'Калужская область': {
            'Калуга': ['2024-06-10.xlsx', 'file_n.xlsx'],
            'Калужская область': ['file_n.xlsx']
        },
        'Московская область': {
            'Москва': ['file_n.xlsx'],
            'Московская область': ['file_n.xlsx']
        }
    },
}
